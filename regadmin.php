...
<br><br><br>
<form action="adadmin.php" method="post">
<fieldset>
    <legend></legend>
    <label>Login</label>
...
$eliusu=$_POST['eliusu'];
?>
<p align="center">Ingrese el nombre del miembro de Love Chic a eliminar</p>
<form action="" method="post" enctype="multipart/form-data">

    <label>Nombre:</label>
    <input type="text" size="28" name="eliusu" required placeholder="Introduzca el nombre a eliminar" /><br><br>
...
$query = "DELETE from usuario where nom_usu = '".$eliusu."'";  
$result = mysql_query($query);  
echo"<script>alert('usted ha borrado un administrador')</script>";
}
?>
<!-- / eliminacion *********************************************** -->
